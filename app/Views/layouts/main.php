...
<head>
    ...
    <title><?= isset($page_title) ? $page_title.' | ' : "" ?>PERUSAHAAN</title>
...
<body class="bg-dark bg-gradient bg-opacity-25">
    ...
    <div class="container">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Vacancies' ? 'active' : '' ?>" href="<?= base_url('Main/vacancies') ?>">Lowongan</a></li>
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Applicants' ? 'active' : '' ?>" href="<?= base_url('Main/applicants') ?>">Pelamar</a></li>
            <li><a class="nav-link <?= isset($page_title) && $page_title == 'Users' ? 'active' : '' ?>" href="<?= base_url('Main/users') ?>">Pengguna</a></li>
        </ul>
        <div class="dropdown">
