                    ...
                    <form action="<?= base_url('login') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group rounded-0">
                                <input type="email" class="form-control rounded-0" id="email" name="email" autofocus placeholder="brave@gmail.com" value="<?= !empty($data->getPost('email')) ? $data->getPost('email') : '' ?>" required>
                        ...
                        <div class="mb-3">
                            <div class="text-center">
                                <a href="<?= base_url('/register') ?>" class="text-decoration-none fw-bold">Tidak punya akun...</a><br>
